...
2. Selena Gomez (0.292)
3. Shawn Mendes (0.292)
4. Sia (0.288)
5. Taylor Swift (0.287)

### Top 5 Betweenness Centrality:
1. Meghan Trainor (0.336)
2. Becky G (0.297)
3. KAROL G (0.166)
4. Maroon 5 (0.145)
5. OneRepublic (0.122)
...
- Business implications and strategy recommendations
- Technical interpretation of network properties

---

*Analysis focused on artists with popularity threshold ≥ 80 using Spotify API data*
